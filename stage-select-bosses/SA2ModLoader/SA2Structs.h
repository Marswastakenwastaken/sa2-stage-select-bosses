...
struct MenuData
{
	std::uint32_t DrawAtAll;
	std::uint32_t field_4;
	std::uint32_t field_8;
	std::uint32_t tex_loaded;
	std::uint32_t drawBackgroundMaybe;
	std::uint32_t field_14;
	std::uint32_t field_18;
	std::uint32_t DrawAtAll_2;
	std::uint32_t field_4_2;
	std::uint8_t  DisplayIcons[4];
	std::uint32_t unk0;
	std::uint32_t drawBackgroundMaybe_2;
	std::uint32_t field_14_2;
	std::uint32_t EnableLevelWindow;
	std::uint32_t unk1;
	std::uint32_t field_4_3;
	std::uint32_t field_8_3;
	std::uint32_t selectedScene;
	std::uint32_t drawBackgroundMaybe_3;
	std::uint32_t field_14_3;
	std::uint32_t field_18_3;
	std::uint32_t currMenu;
	std::uint32_t field_4_2_3;
	std::uint32_t field_8_2_3;
	std::uint32_t field_C_2_3;
	std::uint8_t  someChar;
	std::uint8_t  someChar2;
	std::uint8_t  pad_66;
	std::uint8_t  pad_67;
};
